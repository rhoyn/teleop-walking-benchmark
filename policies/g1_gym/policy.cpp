...
const double G1GYM_DEFAULT_ANGLES[G1GYM_NUM_ACT] = {
    -0.1, 0.0, 0.0, 0.3, -0.2, 0.0, -0.1, 0.0,  0.0, 0.3, -0.2, 0.0, 0.0, 0.3,
    0.3,  0.0, 0.9, 0.0, 0.0,  0.0, 0.3,  -0.3, 0.0, 0.9, 0.0,  0.0, 0.0,
};

const float G1GYM_KPS[G1GYM_NUM_ACT] = {
    100, 100, 100, 200, 20, 20, 100, 100, 100, 200, 20, 20, 100, 90,
    60,  20,  60,  8,   8,  8,  90,  60,  20,  60,  8,  8,  8,
};

const float G1GYM_KDS[G1GYM_NUM_ACT] = {
    2.5f, 2.5f, 2.5f, 5.0f, 0.2f, 0.1f, 2.5f, 2.5f, 2.5f,
    5.0f, 0.2f, 0.1f, 4.0f, 2.0f, 1.0f, 0.4f, 1.0f, 0.2f,
    0.2f, 0.2f, 2.0f, 1.0f, 0.4f, 1.0f, 0.2f, 0.2f, 0.2f,
};
