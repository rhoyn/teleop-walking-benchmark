...
__device__ const float D_DEFAULTS[NUM_LEG] = {
    -0.1f,
    0.0f,
    0.0f,
    0.3f,
...
const policy_api::Limits LIMITS =
    {-0.8, 0.8, 0.5, 1.57, 0.0, 0.08, 0.15, 0.05, 0.10, 1.5, 2.0};

__global__ void k_rl_gym_obs(
